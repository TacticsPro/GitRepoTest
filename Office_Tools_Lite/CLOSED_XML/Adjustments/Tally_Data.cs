...
public class Tally_Data
{
    ...
    private async Task RunMacro(Window mainWindow, string outputExcelFile)
    {
        ...
        try
        {
            byte[] decryptedContentBytes = Transformation.GetTransformedFileContent("Tally_Data.dll");
            ...
            process.StartInfo.Arguments = $"\"{outputExcelFile}\" \"Tally_Data\"";
