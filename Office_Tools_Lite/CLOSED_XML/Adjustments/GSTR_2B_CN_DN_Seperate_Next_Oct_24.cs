...
public class GSTR_2B_CN_DN_Seperate_Next_Oct_24
{
    ...
    public async Task Execute(Window mainWindow)
    {
        ...
        var dialog = await ShowDialog.ShowMsgBox(
            "GSTR-2B CN_DN Seperate (Next Oct-24)",
            "This will merge all the Excel files (B2B-CDNR Sheet) you select.\n\n Click OK to continue.",
        ...
        var inputSheetName = "B2B-CDNR";
        var outputExcelFile = Path.Combine(subDir, "2B_CN_DN_Seperated.xlsx");
        var outputSheetName = "B2B-CDNR";
    ...
    private async Task RunMacro(Window mainWindow, string outputExcelFile)
    {
        ...
        try
        {
            byte[] decryptedContentBytes = Transformation.GetTransformedFileContent("GSTR_2B_CN_DN_Seperate_Next_Oct_24.dll");
            ...
            process.StartInfo.Arguments = $"\"{outputExcelFile}\" \"GSTR_2B_CN_DN_Seperate_Next_Oct_24\"";
