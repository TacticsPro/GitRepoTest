...
public class GSTR_2B_CN_DN_Seperate_Till_Sep_24
{
    ...
    public async Task Execute(Window mainWindow)
    {
        ...
        var dialog = await ShowDialog.ShowMsgBox(
            "GSTR-2B CN_DN Seperate (Till Sep-24)",
    ...
    private async Task RunMacro(Window mainWindow, string outputExcelFile)
    {
        ...
        try
        {
            byte[] decryptedContentBytes = Transformation.GetTransformedFileContent("GSTR_2B_CN_DN_Seperate_Till_Sep_24.dll");
            ...
            process.StartInfo.Arguments = $"\"{outputExcelFile}\" \"GSTR_2B_CN_DN_Seperate_Till_Sep_24\"";
