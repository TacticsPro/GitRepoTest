...
public class GSTR_8A_B2B_compare_Upto_22_23
{
    ...
    public async Task Execute(Window mainWindow)
    {
        ...
        var dialog = await ShowDialog.ShowMsgBox(
            "8A B2B (Upto 22-23)",
            "This will merge all the Excel files (B2B Sheet) you select.\n\n Click OK to continue.",
        ...
        var inputSheetName = "B2B";
        var outputExcelFile = Path.Combine(subDir, "8A_B2B.xlsx");
    ...
    private async Task RunMacro(Window mainWindow, string outputExcelFile)
    {
        ...
        try
        {
            byte[] decryptedContentBytes = Transformation.GetTransformedFileContent("GSTR_8A_B2B_compare_Upto_22_23.dll");
            ...
            process.StartInfo.Arguments = $"\"{outputExcelFile}\" \"GSTR_8A_B2B_compare_Upto_22_23\"";
