...
public class GSTR_8A_CN_DN_Seperate_Upto_22_23
{
    ...
    public async Task Execute(Window mainWindow)
    {
        ...
        var dialog = await ShowDialog.ShowMsgBox(
            "8A CN_DN Seperate (Upto 22-23)",
            "This will merge all the Excel files (CDNR Sheet) you select.\n\n Click OK to continue.",
    ...
    private async Task RunMacro(Window mainWindow, string outputExcelFile)
    {
        ...
        try
        {
            byte[] decryptedContentBytes = Transformation.GetTransformedFileContent("GSTR_8A_CN_DN_Seperate_Upto_22_23.dll");
            ...
            process.StartInfo.Arguments = $"\"{outputExcelFile}\" \"GSTR_8A_CN_DN_Seperate_Upto_22_23\"";
