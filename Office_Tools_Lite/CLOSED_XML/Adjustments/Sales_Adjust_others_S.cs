...
public class Sales_Adjust_others_S
{
    ...
    private async Task RunMacro(Window mainWindow, string outputExcelFile)
    {
        ...
        try
        {
            byte[] decryptedContentBytes = Transformation.GetTransformedFileContent("Sales_Adjust_others_S.dll");
            ...
            process.StartInfo.Arguments = $"\"{outputExcelFile}\" \"Sales_Adjust_others_S\"";
