...
public class GSTR_2A_CN_DN_Seperate_csv
{
    ...
    public async Task Execute(Window mainWindow)
    {
        ...
        var dialog = await ShowDialog.ShowMsgBox(
            "GSTR-2A CN_DN Seperate (csv)",
            "This will merge selected CSV files to Excel file.\n\n Click OK to continue.",
    ...
    private async Task RunMacro(Window mainWindow, string outputExcelFile)
    {
        ...
        try
        {
            byte[] decryptedContentBytes = Transformation.GetTransformedFileContent("GSTR_2A_CN_DN_Seperate_csv.dll");
            ...
            process.StartInfo.Arguments = $"\"{outputExcelFile}\" \"GSTR_2A_CN_DN_Seperate_csv\"";
