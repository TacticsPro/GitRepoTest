...
public class GSTR_8A_CN_DN_Seperate_Next_23_24
{
    ...
    public async Task Execute(Window mainWindow)
    {
        ...
        var outputExcelFile = Path.Combine(subDir, "8A_CN_DN_Seperated.xlsx");
    ...
    private async Task RunMacro(Window mainWindow, string outputExcelFile)
    {
        ...
        try
        {
            byte[] decryptedContentBytes = Transformation.GetTransformedFileContent("GSTR_8A_CN_DN_Seperate_Next_23_24.dll");
            ...
            process.StartInfo.Arguments = $"\"{outputExcelFile}\" \"GSTR_8A_CN_DN_Seperate_Next_23_24\"";
