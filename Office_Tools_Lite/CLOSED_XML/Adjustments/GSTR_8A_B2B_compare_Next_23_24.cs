...
public class GSTR_8A_B2B_compare_Next_23_24
{
    ...
    private async Task RunMacro(Window mainWindow, string outputExcelFile)
    {
        ...
        try
        {
            byte[] decryptedContentBytes = Transformation.GetTransformedFileContent("GSTR_8A_B2B_compare_Next_23_24.dll");
            ...
            process.StartInfo.Arguments = $"\"{outputExcelFile}\" \"GSTR_8A_B2B_compare_Next_23_24\"";
